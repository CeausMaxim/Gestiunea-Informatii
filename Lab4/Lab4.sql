...
/*ALTER TABLE agenti
ADD CONSTRAINT CHK_Agent FOREIGN KEY (Cod_firma)
    REFERENCES firme(Cod_firma);*/
...
/*ALTER TABLE personal 
ADD CONSTRAINT CHK_VIRSTA CHECK (VIRSTA>18);*/

-- Să se șteargă tabela fosti_agenti.
-- DROP TABLE fosti_agenti;

-- Să se șteargă înregistrările tabelei personal.
...
-- Să creeze tabela salariati pe baza tabelei angajati fără a prelua 
...
-- Să se majoreze cu 100 salariul angajaților din tabela salariati care au salariul mai mic decât 3000.
/*UPDATE Salariati
...
-- Să se șteargă angajații din tabela salariati care au id_manager egal cu 122 sau 123.
/*DELETE 
FROM Salariati
